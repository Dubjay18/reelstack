...
function getScoreTier(score: number) {
  if (score >= 800) return { label: 'Master Curator', color: '#f59e0b', bg: 'rgba(245, 158, 11, 0.15)' };
  if (score >= 600) return { label: 'Expert', color: '#10b981', bg: 'rgba(16, 185, 129, 0.15)' };
  if (score >= 400) return { label: 'Curator', color: Colors.primary, bg: 'rgba(79, 219, 200, 0.15)' };
