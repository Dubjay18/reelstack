...
export function GoogleButton() {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-sm bg-surface-container-high hover:bg-surface-container-highest text-on-surface border border-outline-variant rounded-md py-sm px-md transition-colors font-body-sm text-body-sm font-medium"
    >
